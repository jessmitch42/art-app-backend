...
# Nasreen Mohamedi
artist = Artist.create(first_name: "Nasreen", last_name: "Mohamedi", birth_year: 1937, death_year:1990, nationality:"Indian", sources:"https://www.artsy.net/artist/nasreen-mohamedi, https://en.wikipedia.org/wiki/Nasreen_Mohamedi")

artist.update(bio:"Nasreen Mohamedi was an Indian artist best known for her line-based drawings, and is today considered one of the most essential modern artists from India. Despite being relatively unknown outside of her native India during her lifetime, Mohamedi's work has been the subject of remarkable revitalisation in international critical circles and has received popular acclaim over the last decade. Her work has been exhibited at the Museum of Modern Art (MoMA) in New York, the Kiran Nadar Museum of Art in New Delhi, documenta in Kassel, Germany, and at Talwar Gallery, which organised the first solo exhibition of her work outside of India in 2003, and which has represented her estate for over a decade, in New York and in New Delhi. Today, Mohamedi is considered one of the major figures of the art of the twentieth century.")
...
# Carmen Herrera
artist = Artist.create(first_name:"Carmen", last_name:"Herrera", birth_year:1915, nationality:"Cuban", sources:"https://www.artsy.net/artist/carmen-herrera, https://en.wikipedia.org/wiki/Carmen_Herrera")

artist.update(bio:"Carmen Herrera is a Cuban-American abstract, minimalist painter. She was born in Havana and has lived in New York City since the mid-1950s. Herrera's abstract works have brought her international recognition late in life. She turned 100 in May 2015. The key to understanding Carmen Herrera’s style is remembering that, before she left Cuba, she was trained as an architect. This foundation can be seen in her urge to use measurements and tools to create orderly art in a chaotic world. In her own words, Herrera thinks about \“the line, the paper, about a lot of tiny things that get bigger and bigger… and then a picture comes up.\" She is also a self-professed believer in the adage that \“less is more\”.")
...
artist.update(sources:"https://www.artsy.net/artist/anne-truitt, https://en.wikipedia.org/wiki/Anne_Truitt");
...
artist.update(bio:"Helen Frankenthaler was an American abstract expressionist painter. She was a major contributor to the history of postwar American painting. Having exhibited her work for over six decades (early 1950s until 2011), she spanned several generations of abstract painters while continuing to produce vital and ever-changing new work. Frankenthaler began exhibiting her large-scale abstract expressionist paintings in contemporary museums and galleries in the early 1950s. She was included in the 1964 Post-Painterly Abstraction exhibition curated by Clement Greenberg that introduced a newer generation of abstract painting that came to be known as Color Field. Born in Manhattan, she was influenced by Greenberg, Hans Hofmann, and Jackson Pollock's paintings. Her work has been the subject of several retrospective exhibitions, including a 1989 retrospective at the Museum of Modern Art in New York City, and been exhibited worldwide since the 1950s. In 2001, she was awarded the National Medal of Arts.")
